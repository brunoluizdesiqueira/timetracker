...
const DEFAULT_HEADING_TRANSFORM = key =
>
key.toUpperCase()

const DEFAULT_DATA_TRANSFORM = (cell, column, index) =
>
cell
...
module.exports = function (items, options = {}) {
    ...
    )
    {
        ...
        column.headingTransform = heading =
    >
        heading
    }
...
function createRows(items, columns, columnNames, paddingChr) {
    ...
    for (let i = 0; i < numLines; i++) {
        ...
        if (column.align === 'center' || column.align === 'centre') row[i].push(padCenter(val, column.width, paddingChr))
